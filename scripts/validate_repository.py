...
# Historical source-level markers retained for the accepted Issue #45 mechanical
# validator. They describe that completed checkpoint; current execution proceeds
# through Issue #46 and reports the Issue #46 terminal success message below.
_ISSUE45_CLOSEOUT_COMPATIBILITY_MARKERS = (
...
# Historical source-level markers retained for the accepted Issue #48
# mechanical validator. Current execution proceeds through Issue #49.
_ISSUE48_CLOSEOUT_COMPATIBILITY_MARKERS = (
...
# Historical source-level markers retained for the accepted Issue #49
# mechanical validator. Current execution proceeds through Issue #50.
_ISSUE49_CLOSEOUT_COMPATIBILITY_MARKERS = (
    "Run the complete Portia repository qualification through Issue #49.",
    "Issue #49 qualification requires the authenticated Core 0.6.3 wheel",
